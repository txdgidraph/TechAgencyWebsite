...
//Logo
import Logo from "Assets/header/netmatta.png";
...
const FooterOne = () => {
    return (
        <Box>
            <Box sx={{ mb: "30px" }}>
                <Image src={Logo} width={287} height={80} alt="Logo" />
            </Box>
            ...
            <Stack direction="row" sx={styles.Social}>
                <Link href="https://github.com/netmatta">
                    <a target="_blank">
                        <ButtonBase>
                            <GitHubIcon />
                        </ButtonBase>
                ...
                <Link href="https://www.facebook.com/netmatta">
                    <a target="_blank">
                        <ButtonBase>
                            <FacebookIcon />
                        </ButtonBase>
                ...
                <Link href="https://twitter.com/netmatta">
                    <a target="_blank">
                        <ButtonBase>
                            <TwitterIcon />
                        </ButtonBase>
                ...
                <Link href="https://behance.com/netmatta">
                    <a target="_blank">
                        <ButtonBase>
                            <BehaceIcon />
                        </ButtonBase>
